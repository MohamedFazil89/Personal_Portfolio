...
const AboutModal = ({ onClose }) => {
  // Mobile detection (runs once; if you want live resize, use a hook)
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            marginBottom: '10px',
            fontSize: isMobile ? '0.91rem' : '1.05rem'
          }}>
            {/* Terminal Output */}
            <div style={{
              maxHeight: isMobile ? '95px' : '190px',
              overflowY: 'auto',
              marginBottom: '10px',
              paddingRight: '5px'
            }}>
            ...
            <div style={{ display: 'flex', gap: '7px', alignItems: 'center' }}>
              <span style={{ color: diffConfig.color, fontSize: isMobile ? '1.1rem' : '1.15rem', fontWeight: '700' }}>$</span>
              <input
                type="text"
                value={inputValue}
            ...
            <div style={{
              ...
              background: `${diffConfig.color}08`,
              border: `1px solid ${diffConfig.color}17`,
              borderRadius: '4px',
              fontSize: isMobile ? '0.81rem' : '0.92rem',
              color: 'var(--text-secondary)',
              overflowX: 'auto'
            }}>
              💡 Quick commands:
